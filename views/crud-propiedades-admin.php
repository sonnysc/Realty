                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="../controllers/php/registro_propiedad.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="card card-body">
                <table class="table table-hover table-striped">
                    ...
                    if(isset($_POST['btnBuscar'])){
                        ...
                        if(strlen($buscar) >= 1){
                            $query = "SELECT * FROM propiedades WHERE id_propiedad = '$buscar' OR titulo LIKE '%$buscar%' OR pais LIKE '%$buscar%' OR estado LIKE '%$buscar%' OR municipio LIKE '%$buscar%' OR codigo_postal LIKE '%$buscar%' OR calle LIKE '%$buscar%' OR colonia LIKE '%$buscar%' OR tipo_inmueble LIKE '%$buscar%' OR tipo_contrato LIKE '%$buscar%' OR precio LIKE '%$buscar%' OR descripcion LIKE '%$buscar%'";
                        } 
                    }   
...
<script src="../controllers/js/opciones_propiedades.js"></script>
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        eliminarBtns.forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                confirmarEliminarBtn.setAttribute('href', '../controllers/php/eliminar-propiedad.php?id_propiedad=' + idPropiedad);
            });
        });
    });
</script>
